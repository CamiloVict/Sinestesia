...
void draw(){
   ...
   if ( miPuerto.available() > 0) 
    {                                                         /* Si el valor esta disponible */
     ...
     valorInt = miPuerto.read();                          /* Recibiendo 'int'*/
    }    
    ...
    */
    ...
    // Condición para reproducir el vídeo RECIBIENDO DE ARDUINO INT
    
  /*switch(valorInt){
  case 1:
       //miPelicula.play();
       //image(miPelicula, 0, 0);
       println("UEPA ENTRE !!!!!!!!!");
  break;
       
  case 0:
       //miPelicula.pause();
       println("Estoy en pausa -----");
  break;
  
  default:
  break;
  }*/
     //image(miPelicula,width,height);
